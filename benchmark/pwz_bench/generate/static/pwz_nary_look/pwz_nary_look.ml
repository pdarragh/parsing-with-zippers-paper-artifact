...
let add_to_lookahead_worklist (e : exp) : unit =
    lookahead_worklist := (e :: !lookahead_worklist)

let add_parents_to_lookahead_worklist (e : exp) : unit =
    List.iter add_to_lookahead_worklist e.parents
